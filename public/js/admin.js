        ...
        requests.data.forEach((request) => {
          ...
          `;
            ...
            <tr>
                ...
                <span><button class="detail-btn pending action-reject" onclick="rejectRequest('${request.request_id}')"><ion-icon name="done-all"></ion-icon>Reject</button>
                </td>
              </tr>
          `;
            approved += `
            ...
            <tr>
                ...
                <td data-label='Sender'><span>${request.firstname} ${request.lastname}</span></td>
                <td data-label='Details'><a href="#confirm" class="detail-btn pending" onclick="getRequestDetails('${request.request_id}')">Details</a></td>
                <td data-label='Actions'><span><button class="detail-btn pending action-approve" onclick="approveRequest('${request.request_id}')"><ion-icon name="done-all"></ion-icon>Approve</button></td>
              </tr>
            `;
            rejected += `
            <tr>
          ...
          `;
            ...
            <tr>
                ...
                <td data-label='Sender'><span>${request.firstname} ${request.lastname}</span></td>
                <td data-label='Details'><a href="#confirm" class="detail-btn pending" onclick="getRequestDetails('${request.request_id}')">Details</a></td>
                <td data-label='Actions'><span><button class="detail-btn pending action-approve" onclick="approveRequest('${request.request_id}')"><ion-icon name="done-all"></ion-icon>Unresolve</button></td>
              </tr>
          `;
            resolved += `
            <tr>
